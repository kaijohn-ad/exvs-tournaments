...
export async function loader({ params, context }: LoaderFunctionArgs) {
	...
	try {
		...
		console.error("[events.$eventId.schedule:load] failed", {
			eventId,
...
export const meta: MetaFunction<typeof loader> = ({ data }) => [
	{ title: `${data?.event.name || "イベント"} - スケジュール | Boost Bracket` },
	{ name: "description", content: `${data?.event.name || "イベント"}の試合スケジュール` },
];
